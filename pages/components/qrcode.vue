<template>
	<view class="container">
		...
		<view class="bg-grey padding-sm margin-bottom">
		...
		<view class="qrimg">
			...
			<view class="qrimg-i">
				<tki-qrcode v-if="ifShow" cid="qrcode2" ref="qrcode2" val="欢迎,喜欢记得点个赞哦" :size="size" :onval="onval" :loadMake="loadMake" :usingComponents="true" @result="qrR" />
			</view>
		</view>
		...
		<view class="list">
			<slider :value="size" @change="sliderchange" min="50" max="300" show-value />
		</view>
		<view class="margin-tb-sm">
			<view class="btns">
