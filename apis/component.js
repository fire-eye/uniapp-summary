...
const lists = [
	...
	},
	{
		...
		link : '/pages/components/text-rich/text-rich',
		icon : 'lIcon-rich'
	},
	{
		title : '图表',
		desc : '简介',
		link : '/pages/components/echat/echat',
		icon : 'lIcon-chart-1'
	},
	{
		title : '海报',
		desc : '简介',
		link : '/pages/components/canvas/canvas',
		icon : 'lIcon-poster'
	},
	{
		title : '视频',
		desc : '视屏功能应用案例,包含弹幕与弹幕发布',
		link : '/pages/components/video/video',
		icon : 'lIcon-draw'
	},
	{
		title : '抽奖',
		desc : '简介',
		link : '/pages/components/luck-draw/demo',
		icon : 'lIcon-draw'
	},
	{
		title : '二维码',
